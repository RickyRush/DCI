...
```
alert tcp any any -> 10.10.10.10 any (msg:"TCP connection to $HOME_NET"; sid:10001; )
alert udp any any -> 10.10.10.10 any (msg:"UDP connection to $HOME_NET"; sid:10002; )
alert ip any any -> 10.10.10.10 any ( content:"delete", nocase; msg:"Content 'delete' detected"; sid:10003; )
alert ip any any <> any any ( content:"drop", nocase; msg:"Content 'drop' detected"; sid: 10004; )
```

`snort -i 1 -c c:\snort\etc\snort.conf -l c:\snort\log\ -A full`  